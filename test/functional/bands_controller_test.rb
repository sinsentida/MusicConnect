...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { homepage: @band.homepage, image: @band.image, location: @band.location, name: @band.name, style: @band.style }
    end
  ...
  test "should update band" do
    put :update, id: @band, band: { homepage: @band.homepage, image: @band.image, location: @band.location, name: @band.name, style: @band.style }
    assert_redirected_to band_path(assigns(:band))
  end
